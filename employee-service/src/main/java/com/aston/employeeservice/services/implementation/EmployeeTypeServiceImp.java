...
public class EmployeeTypeServiceImp implements EmployeeTypeService {
    ...
    @Override
    public List<EmployeeType> addTypeList(List<EmployeeType> employeeType) {
        List<EmployeeType> employeeTypeList = new ArrayList<>();
        this.employeeTypeRepository.saveAll(employeeType).iterator().forEachRemaining(employeeTypeList::add);
        return employeeTypeList;
    }
